"""
This program searches google using 'hospital-name'+'city'+'state'+'zip'
information contained in 'Hospital_General_Information.csv'
and returns the first 3 google hits, which are then saved to
'Hospital_General_Information_url.csv'. These are used later as starting
points to search for pricing files.

The code relies on the Google-Search-API package.
Installation instructions for it are provided below:
